...
@section('js')
    ...
    <script>
        var ticketUrl = "{{ route('venta.ticket', ['id' => ':id']) }}";
        var anularUrl = "{{ route('venta.anular', ['id' => ':id']) }}";
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            return `<a class="btn btn-sm btn-danger" target="_blank" href="${ticketUrl.replace(':id', row.id)}"><i class="fas fa-print"></i></a>` +
        ...
        function anularVenta(ventaId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    form.action = anularUrl.replace(':id', ventaId);
