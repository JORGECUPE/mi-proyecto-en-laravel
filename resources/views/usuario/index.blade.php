...
@section('js')
    ...
    <script>
        var editUrl = "{{ route('usuarios.edit', ['usuario' => ':id']) }}";
        var editRol = "{{ route('rol.edit', ['id' => ':id']) }}";
        var deleteUrl = "{{ route('usuarios.destroy', ['usuario' => ':id']) }}";
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            return `<a class="btn btn-sm btn-info" href="${editRol.replace(':id', row.id)}"><i class="fas fa-key"></i></a>` +
                                `<a class="btn btn-sm btn-primary" href="${editUrl.replace(':id', row.id)}"><i class="fas fa-edit"></i></a>` +
        ...
        function deleteUser(userId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    form.action = deleteUrl.replace(':id', userId);
