...
@section('js')
    ...
    <script>
        var editUrl = "{{ route('proveedores.edit', ['proveedore' => ':id']) }}";
        var deleteUrl = "{{ route('proveedores.destroy', ['proveedore' => ':id']) }}";
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            return `<a class="btn btn-sm btn-primary" href="${editUrl.replace(':id', row.id)}"><i class="fas fa-edit"></i></a>` +
        ...
        function deleteProveedor(proveedorId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    form.action = deleteUrl.replace(':id', proveedorId);
