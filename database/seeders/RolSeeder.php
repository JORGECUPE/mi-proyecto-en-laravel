...
class RolSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // $role3 = Role::create(['name' => 'Apoyo']);
        $role1 = Role::firstOrCreate(['name' => 'Admin'], ['guard_name' => 'web']);
        $role2 = Role::firstOrCreate(['name' => 'Vendedor'], ['guard_name' => 'web']);
        $role3 = Role::firstOrCreate(['name' => 'Apoyo'], ['guard_name' => 'web']);
        $role4 = Role::firstOrCreate(['name' => 'User'], ['guard_name' => 'web']);

        // Crear permisos de forma segura
        ...
        Permission::firstOrCreate(['name' => 'productos.index'])->syncRoles([$role1]);
        Permission::firstOrCreate(['name' => 'productos.create'])->syncRoles($role1);
        ...
        Permission::firstOrCreate(['name' => 'categorias.index'])->syncRoles([$role1]);
        Permission::firstOrCreate(['name' => 'categorias.edit'])->assignRole($role1);
        Permission::firstOrCreate(['name' => 'categorias.create'])->syncRoles($role1);
        ...
        Permission::firstOrCreate(['name' => 'clientes.index'])->syncRoles([$role1, $role2, $role3]);
        Permission::firstOrCreate(['name' => 'clientes.create'])->syncRoles([$role1, $role2, $role3]);
        ...
        Permission::firstOrCreate(['name' => 'cajas.index'])->syncRoles([$role1, $role2, $role3]);
        Permission::firstOrCreate(['name' => 'cajas.create'])->syncRoles([$role1, $role2, $role3]);
        Permission::firstOrCreate(['name' => 'cajas.update'])->syncRoles([$role1, $role2, $role3]);
